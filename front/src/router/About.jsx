        ...
        <div className='  w-auto h-screen flex  max-sm:flex-col max-sm:flex-col '>
          ...
          <div className='p-20 ml-10 max-sm:p-0 w-[50%] max-sm:w-full max-'>
            ...
            <div className='max-sm:ml-0'>
              ...
              <h1 className='text-[22px] primary_text1 text-red-600 font-thin font-bold m-5 max-sm:text-center max-sm:m-0'>I'm a Web Developer</h1>
              <h1 className='text-[35px] primary_text1  pr-20 font-thin font-semibold m-5 max-sm:p-0 max-sm:m-0 max-sm: text-left max-sm:mb-10'>I Can Design Anything You Want</h1>
              <h1 className='text-[16px] primary_text1  max-sm:w-[80%] max-sm:m-0 font-thin font-thin m-5 line leading-9'>Hello there! I'm a web designer, and I'm very passionate and dedicated to my work. With 2 years experience as a professional web developer, I have acquired the skills and knowledge necessary to make your project a success. I enjoy every step of the design process, from discussion and collaboration.</h1>
