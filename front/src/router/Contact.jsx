        ...
        <div className='flex mt-16 max-sm:flex-col max-sm:pl-5  '>
          ...
          <div className='w-[50%] mt-10'>
            <form onSubmit={handleSubmit} className="max-w-lg max-sm:w-full ">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 max-sm:w-[360px]" >
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <textarea
                ...
                className="border border-gray-300 p-2 rounded-md w-full mb-4 h-32  bg-slate-100  max-sm:w-[360px]"
                required
              />
              <button
                type="submit"
